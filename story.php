  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate mb-5 text-center">
        <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>My Story <i class="fa fa-chevron-right"></i></span></p>
        <h1 class="mb-0 bread">My Story</h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <div class="col-md-6 wrap-about px-md-5 ftco-animate py-5 bg-light">
        <div class="heading-section py-md-5">
          <span class="subheading">This is my story</span>
          <h2 class="mb-4">Sophie's Story</h2>
