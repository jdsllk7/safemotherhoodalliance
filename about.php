...
<head>
  <title>About | Safe Motherhood Alliance</title>
</head>
...
<section class="ftco-section ftco-no-pb ftco-no-pt">
  <div class="container">
    <div class="row">
      <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url('images/banner/084e5242fd3c48e484455d908d4240dd.jpg');">
      </div>
      <div class="col-md-6 wrap-about px-md-5 ftco-animate py-5 bg-light">
        <div class="heading-section py-md-5">
          <span class="subheading">Welcome to Safe Motherhood Alliance</span>
          <h2 class="mb-4">Improving maternal and child health in Zambia</h2>
